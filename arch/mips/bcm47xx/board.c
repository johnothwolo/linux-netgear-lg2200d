...
struct bcm47xx_board_type_list1 bcm47xx_board_list_board_id[] __initconst = {
	...
	{{BCM47XX_BOARD_NETGEAR_LG2200D_v1, "Netgear LG2200D V1"}, "U12H222T02_NETGEAR"}, // also known as MBRN2000
	{ {0}, NULL},
};
...
struct bcm47xx_board_type_list3 bcm47xx_board_list_board[] __initconst = {
	...
	{{BCM47XX_BOARD_NETGEAR_LG2200D_v1, "Netgear LG2200D V1"}, "0x053d", "01", "0x1340"},
